...
- Generate two writing questions, each requiring a 150-200 word essay.
    - Question 1: An opinion essay on a given topic.
    - Question 2: A descriptive or narrative essay on a given topic.
...
- Return the final exam as a JSON file that can be controlled and formatted easily.
`;

// Note the prompt must be changed and organized as JSON template with instructions 
// The token size must be increased to acheive the goal
